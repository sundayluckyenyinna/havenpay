...
const ValidationModule_1 = require("../validation/ValidationModule");
let CustomerModule = class CustomerModule {
};
CustomerModule = __decorate([
    (0, common_1.Module)({
        imports: [ValidationModule_1.default],
        controllers: [CustomerController_1.default],
        providers: [CustomerService_1.default, PrismaRepository_1.default]
    })
], CustomerModule);
